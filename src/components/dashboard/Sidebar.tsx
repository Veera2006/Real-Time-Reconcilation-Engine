...
const menuItems = [
  ...
  { icon: ArrowLeftRight, label: 'Reconciliation', active: false },
  { icon: AlertTriangle, label: 'Mismatches', active: false, badge: 5 },
  { icon: Clock, label: 'Pending', active: false, badge: 2 },
